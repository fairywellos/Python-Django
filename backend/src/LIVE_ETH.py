...
today_equity_line = open ( path + "LIVE_MA-1-21_ETH_USD_kraken_equity.log" ,"r" ).readlines()[-1].split(",")
today_trades_line = open ( path + "LIVE_MA-1-21_ETH_USD_kraken_trades.log" ,"r" ).readlines()[-1].split("\t")

## set initial value
strategy = "LIVE_MA-1-21_ETH_USD"
date = ""
quantity = ""
entry = ""
last_price = ""
...
## get each info
def get_each_LIVE_ETH():
    total_trades = open ( path + "LIVE_MA-1-21_ETH_USD_kraken_trades.log" ,"r" ).readlines()
