...
today_equity_line = open ( path + "MA-1-21_XMR_USD_kraken_equity.log" ,"r" ).readlines()[-1].split(",")
today_trades_line = open ( path + "MA-1-21_XMR_USD_kraken_trades.log" ,"r" ).readlines()[-1].split("\t")

## set initial value
strategy = "MA-1-21_XMR_USD"
date = ""
quantity = ""
entry = ""
last_price = ""
...
## get each info
def get_each_XMR():
    total_trades = open ( path + "MA-1-21_XMR_USD_kraken_trades.log" ,"r" ).readlines()
